...
def test_mixed_templating_success(ast_input: ast.AST, ast_expected: ast.AST):
    ...
    (
        ...
        (
            ...
            {"s"},
            {
                "True", "10", "13",
                "15", "5", '"1"', '"2"',
                '"3"', '"4"', '"random_path"', '"r"', '"utf-8"',
                "0", "100", "12", '"text"', "Ellipsis", "1", "2",
            },
        ),
    )
)
def test_mixed_vars_consts_success(
